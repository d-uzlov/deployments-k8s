...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nsmgr-death/remote-nse?ref=7a44b60e2a6de1263259f61f7bf2ccda5f82e9a0
```
...
Kill remote NSMgr:
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nsmgr-death/nsmgr-death?ref=7a44b60e2a6de1263259f61f7bf2ccda5f82e9a0
```

Start local NSE instead of the remote one:
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nsmgr-death/local-nse?ref=7a44b60e2a6de1263259f61f7bf2ccda5f82e9a0
```
...
Restore NSMgr setup:
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/apps/nsmgr?ref=7a44b60e2a6de1263259f61f7bf2ccda5f82e9a0 -n nsm-system
```
