...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/d-uzlov/deployments-k8s/examples/spire/cluster3?ref=6bd62e7cbe871b4ccd92a2bf0a5dbaf408eef820
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -f https://raw.githubusercontent.com/d-uzlov/deployments-k8s/6bd62e7cbe871b4ccd92a2bf0a5dbaf408eef820/examples/spire/cluster3/clusterspiffeid-template.yaml
```
