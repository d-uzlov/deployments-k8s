...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/spire/cluster2?ref=c6466909ce55b440777cb06e0c9b41bd089403cd
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/d-uzlov/deployments-k8s/c6466909ce55b440777cb06e0c9b41bd089403cd/examples/spire/cluster2/clusterspiffeid-template.yaml
```
