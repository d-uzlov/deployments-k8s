...
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/annotated-namespace?ref=47df790e254afd83bd80b052dbc447a6560034d6
```
...
Apply client patch:
```bash
kubectl apply -f https://raw.githubusercontent.com/d-uzlov/deployments-k8s/47df790e254afd83bd80b052dbc447a6560034d6/examples/features/annotated-namespace/client.yaml
```
