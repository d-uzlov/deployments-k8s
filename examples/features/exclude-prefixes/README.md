...
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/exclude-prefixes/configmap?ref=7a44b60e2a6de1263259f61f7bf2ccda5f82e9a0
```

Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/exclude-prefixes?ref=7a44b60e2a6de1263259f61f7bf2ccda5f82e9a0
```
