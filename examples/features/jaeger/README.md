...
Apply Jaeger pod:
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/jaeger/jaeger?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9
```
...
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/jaeger/opentelemetry?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9
```

Apply Spire deployments (required for NSM system)
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/spire/single_cluster?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9
```
...
Apply NSM resources:
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/jaeger/nsm-system?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9
```
