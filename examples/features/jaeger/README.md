...
Apply Jaeger pod:
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/jaeger/jaeger?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc
```
...
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/jaeger/opentelemetry?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc
```

Apply Spire deployments (required for NSM system)
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/spire/single_cluster?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc
```
...
Apply NSM resources:
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/jaeger/nsm-system?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc
```
