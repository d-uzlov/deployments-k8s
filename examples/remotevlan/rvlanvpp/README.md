...
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/remotevlan/rvlanvpp?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9
```
...
```bash
kubectl delete -k https://github.com/d-uzlov/deployments-k8s/examples/remotevlan/rvlanvpp?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9
```
