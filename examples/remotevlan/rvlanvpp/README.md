...
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/remotevlan/rvlanvpp?ref=63d2effb4e93b0238bd80c5af9bd899b1245b6ba
```
...
```bash
kubectl delete -k https://github.com/d-uzlov/deployments-k8s/examples/remotevlan/rvlanvpp?ref=63d2effb4e93b0238bd80c5af9bd899b1245b6ba
```
