...
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/remotevlan/rvlanovs?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50
```
...
```bash
kubectl delete -k https://github.com/d-uzlov/deployments-k8s/examples/remotevlan/rvlanovs?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50
```
