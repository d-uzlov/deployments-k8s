...
```bash
kubectl apply -f https://raw.githubusercontent.com/d-uzlov/deployments-k8s/6bd62e7cbe871b4ccd92a2bf0a5dbaf408eef820/examples/k8s_monolith/external_nsc/spiffe_federation/clusterspiffeid-template.yaml
```
