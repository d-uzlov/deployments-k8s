...
```bash
kubectl apply -f https://raw.githubusercontent.com/d-uzlov/deployments-k8s/47df790e254afd83bd80b052dbc447a6560034d6/examples/k8s_monolith/external_nsc/spiffe_federation/clusterspiffeid-template.yaml
```
