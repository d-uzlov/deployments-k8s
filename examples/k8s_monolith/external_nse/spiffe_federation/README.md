...
```bash
kubectl apply -f https://raw.githubusercontent.com/d-uzlov/deployments-k8s/c6466909ce55b440777cb06e0c9b41bd089403cd/examples/k8s_monolith/external_nse/spiffe_federation/clusterspiffeid-template.yaml
```
