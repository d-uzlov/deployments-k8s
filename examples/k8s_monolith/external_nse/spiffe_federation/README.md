...
```bash
kubectl apply -f https://raw.githubusercontent.com/d-uzlov/deployments-k8s/7a44b60e2a6de1263259f61f7bf2ccda5f82e9a0/examples/k8s_monolith/external_nse/spiffe_federation/clusterspiffeid-template.yaml
```
