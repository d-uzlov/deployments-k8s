...
Deploy NSC:
```bash
kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/k8s_monolith/external_nse/usecases/Kernel2IP2Kernel?ref=63d2effb4e93b0238bd80c5af9bd899b1245b6ba
```
